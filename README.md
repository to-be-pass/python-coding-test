...
> ✅ 해당 저장소는 누구나 사용할 수 있는 아무런 조건도 제약도 없는 자유로운 저장소 입니다. <br/>
> ✅ 책을 혼자 공부하시는 분들, 책을 스터디로 공부 중인 분들도 저장소를 활용해보세요! <br/>
...
- PR 을 생성하면 자동으로 리뷰어로 등록 된 스터디원중 한명이 리뷰어로 선택됩니다.
- 리뷰어로 활동하고 싶으신 분은 따로 알려주세요!
- 리뷰어가 리뷰를 남기는 활동도 100% 자유입니다. 리뷰를 하면 좋고 아니여도 좋습니다. 부담 갖지마세요!
...
2. 저장소에 사용방법에 대한 문의 ex) 로컬에서 디버깅 방법
3. 추가 해줬으면 기능, 개선 했으면 기능
