...
[서적 공식 저장소](https://github.com/dremdeveloper/codingtest_python)
...
4. ✨ 숫자는 반드시 3자리로 빈자리는 0으로 채워야 합니다! ex) 001, 010, 900
...
- 테스트를 통과하면 solution 브랜치에 `merge`합니다.
...
> 문제를 푸는 것에서 끝나지 않고 커밋으로 기록하고 다시 회고해보세요!
> 해당 저장소는 PR이 모이면 모일수록! 서로 함께하면 할 수록!
> 더 개발자는 성장할 수 있는 힘이 생깁니다!
> 감사합니다. 😊
